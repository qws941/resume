...
environments:
  ...
  development:
    ...
    command: "cd typescript/portfolio-worker && python3 -m http.server 8000"
```
...
external_services:
  cloudflare_workers:
    ...
    config_file: "typescript/portfolio-worker/wrangler.toml"
    worker_file: "typescript/portfolio-worker/worker.js"
...
critical_paths:
  web_portfolio:
    - "typescript/portfolio-worker/index.html"         # Main portfolio page
    - "typescript/portfolio-worker/resume.html"        # Resume HTML version
    - "typescript/portfolio-worker/worker.js"          # Generated worker code (deployed)
    - "typescript/portfolio-worker/generate-worker.js" # Worker generator script
    - "typescript/portfolio-worker/wrangler.toml"      # Cloudflare Workers config
...
generated_files:
  - "typescript/portfolio-worker/worker.js"  # Generated by generate-worker.js
...
deployment_flow:
  ...
  steps:
    ...
    2_deploy_worker:
      ...
      working_directory: "typescript/portfolio-worker/"
...
local_development:
  ...
  worker_generation:
    ...
    command: "cd typescript/portfolio-worker && node generate-worker.js"
    output: "typescript/portfolio-worker/worker.js"
