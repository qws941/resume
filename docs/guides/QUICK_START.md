...
# This creates web/worker.js (auto-generated, ~152KB)
...
| ---------------- | -------------- | ---------------------------- |
| `web/data.json`  | Project data   | Add/remove/update projects   |
| `web/styles.css` | All CSS        | Change colors, fonts, layout |
| `web/index.html` | HTML structure | Modify page structure        |
| `web/worker.js`  | **NEVER EDIT** | Auto-generated by build      |
...
- Edit `web/worker.js` directly (auto-generated)
...
2. **Explore the codebase**:
   - Check `web/generate-worker.js` - Build pipeline
   - Review `web/data.json` - Data structure
