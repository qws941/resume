...
**Libraries (3):**
1. `web/lib/i18n.js` (180 lines)
2. `web/lib/performance-metrics.js` (280 lines)
3. `web/lib/ab-testing.js` (280 lines)
...
8. Various wanted-mcp files (separate project)
...
1. **ESLint Warnings**: 38 warnings
   ...
   - 32 in wanted-mcp directory (separate project)
...
2. Clean up unused variables in wanted-mcp
