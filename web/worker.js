        ...
        <div class="container">
            <div class="hero-content">
                ...
                <p class="hero-subtitle">
                    ...
                    프로덕션 시스템 안정적 운영. 퍼블릭 Grafana로 투명한 인프라 운영 공개.
                </p>
                <div class="hero-cta">
    ...
    <section class="section" id="documentation">
        <div class="container">
            <div class="section-header">
                <div class="section-badge">Technical Docs</div>
                <h2 class="section-title">Nextrade Securities Exchange</h2>
                <p class="section-description">
                    대한민국 최초 신규 증권거래소(20년만) 보안 인프라 구축 및 운영. Zero Trust Architecture, 24/7 SOC, 재해복구 체계 완비. 19개월 연속 무사고, FSC 감사 0건 지적.
                </p>
            </div>
            ...
            <div class="docs-grid">
                ...
                <div class="doc-card">
                    ...
                    <p class="doc-description">RTO 4시간 → 2.5시간 달성, RPO 15분, 정기 테스트 수행</p>
                    <div class="doc-stats">
                        <span class="doc-stat">37% faster</span>
                ...
                <div class="doc-card">
                    ...
                    <p class="doc-description">24/7 보안관제, 월 6천+ 이벤트, MTTD 3.2분, MTTR 27min</p>
                    <div class="doc-stats">
                        <span class="doc-stat">3-shift coverage</span>
    ...
    <section class="section" id="projects">
        <div class="container">
            <div class="section-header">
                ...
                <p class="section-description">
                    실제 운영 중인 프로덕션 시스템. 모든 프로젝트는 퍼블릭 Grafana 대시보드에서 실시간 모니터링되며, 자동화된 CI/CD를 통해 관리됩니다.
                </p>
            </div>
            ...
            <div class="projects-grid">
                ...
                <div class="project-card">
                    ...
                    <div class="project-body">
                        ...
                        <p class="project-description">
                            산업보건 SaaS, Edge API 전국 동시접속 지원, 집계 오류 개선, 실시간 대시보드
                        </p>
                        <div class="project-links">
                ...
                <div class="project-card">
                    <div class="project-header">📊</div>
                    <div class="project-body">
                        <h3 class="project-title">Public Grafana Dashboard</h3>
                        <div class="project-tech">Grafana · Prometheus · Loki · Tempo · PUBLIC</div>
                        <p class="project-description">
                            퍼블릭 접근 가능한 실시간 모니터링, 13개 서비스 통합, 메트릭·로그·트레이스, 안정적 운영
                        </p>
                        <div class="project-links">
                            <a href="https://grafana.jclee.me" target="_blank" class="project-link project-link-primary">Public Dashboard</a>
    ...
    <div class="resume-container">
        ...
        <section class="section">
            ...
            <div class="experience-item">
                ...
                <p class="role">정보보안 운영 엔지니어 | Nextrade(다자간매매체결회사) 운영SM</p>
                <div class="achievement">보안 솔루션 운영: 시스템보안 / 네트워크보안 / 엔드포인트보안</div>
            ...
            <div class="experience-item">
                ...
                <p class="role">프리랜서 인프라 엔지니어 | Nextrade(다자간매매체결회사) 구축 프로젝트</p>
                <div class="achievement">보안 아키텍처 설계 및 망분리 환경 구축</div>
                <div class="achievement">보안 솔루션 도입: 시스템보안 / 네트워크보안 / 엔드포인트보안</div>
                <div class="achievement">자동화 개발: Python 기반 방화벽/NAC/DLP 정책 관리 프레임워크 구축</div>
                <div class="achievement">다자간매매체결회사 사전인가 / 본인가 지원(정보보안)</div>
            </div>
            ...
            <div class="experience-item">
                ...
                <div class="achievement">재택근무 인프라 구축: SSL VPN, NAC 솔루션 통합</div>
                <div class="achievement">Python 자동화: 네트워크 스위치 점검 시스템 개발</div>
        ...
        <section class="section">
            ...
            <div class="docs-grid">
                <div class="doc-card">
                    <div class="doc-icon">🏗️</div>
                    <h3 class="doc-title">Architecture</h3>
                    <p class="doc-description">보안 아키텍처, 보안 솔루션, 자동화 프레임워크</p>
                    <div class="doc-links">
                        <a href="https://github.com/qws941/resume/raw/master/resume/nextrade/exports/ARCHITECTURE_COMPACT.pdf" download class="doc-link-pdf">PDF</a>
                        <a href="https://github.com/qws941/resume/raw/master/resume/nextrade/exports/ARCHITECTURE_COMPACT.docx" download class="doc-link-docx">DOCX</a>
                    </div>
                ...
                <div class="doc-card">
                    <div class="doc-icon">🛡️</div>
                    <h3 class="doc-title">보안관제 운영</h3>
                    <p class="doc-description">보안관제, 대응 플레이북, SIEM 대시보드</p>
                    <div class="doc-links">
                        <a href="https://github.com/qws941/resume/raw/master/resume/nextrade/exports/SOC_RUNBOOK_COMPACT.pdf" download class="doc-link-pdf">PDF</a>
                        <a href="https://github.com/qws941/resume/raw/master/resume/nextrade/exports/SOC_RUNBOOK_COMPACT.docx" download class="doc-link-docx">DOCX</a>
                    </div>
                ...
                <div class="doc-card">
                    <div class="doc-icon">📦</div>
                    <h3 class="doc-title">Complete Package</h3>
                    <p class="doc-description">전체 기술 문서 통합본 (아키텍처 + 재해복구 + 보안관제)</p>
                    <div class="doc-links">
        ...
        <section class="section">
            ...
            <div class="projects-grid">
                <div class="project-card">
                    <h3 class="project-name">보안 통합 관리 플랫폼</h3>
                    <div class="project-tech">Node.js · Cloudflare Workers · REST API · Webhook</div>
                    <p class="project-description">
                        방화벽 중앙관리 플랫폼 개발, 정책 검증 자동화
                    </p>
                    <div class="project-links">
...
const VERSION = '1.0.0';
const DEPLOYED_AT = '2025-10-18T07:59:39.437Z';
