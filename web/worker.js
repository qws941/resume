    ...
    <style>
        * {
        ...
        .skill-category:hover {
            transform: translateY(-8px);
            box-shadow: 0 16px 48px rgba(139, 92, 246, 0.15), 0 0 0 1px rgba(139, 92, 246, 0.1);
        ...
        .stat-card:hover {
            ...
            box-shadow: 0 24px 60px rgba(139, 92, 246, 0.2), 0 0 0 1px rgba(139, 92, 246, 0.1);
            border-color: rgba(139, 92, 246, 0.3);
        }
        ...
        .stat-card:hover .stat-icon {
            filter: grayscale(0) drop-shadow(0 8px 16px rgba(139, 92, 246, 0.3));
